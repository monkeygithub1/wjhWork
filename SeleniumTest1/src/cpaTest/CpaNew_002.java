 ...
 * 新版流程
 */
public class CpaNew_002 {
	WebDriver driver;
	String username = "13910623294";
	String username_fawu = "15822223160";//法务
	String username_dept = "13821635337";//UIUE部
	String username_sybzjl = "13512968527";
	String username_sybdsz = "18602270056";
	...
	String cpa_money = "1998";
	String cpa_dept = "UIUE设计部";
	String cpa_time = "1";
