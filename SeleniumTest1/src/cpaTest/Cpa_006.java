...
//	String username_wuzi = "13820781432";
	...
	String username_fg_zhineng= "13502103187";//物资管理部对应分管领导
	String passwd = "qw";
	String cpa_name = "自动化甲方合同-口头-物资管理部";
	String cpa_money = "1000";
	String cpa_dept = "物资管理部";
	String cpa_time = "1";
