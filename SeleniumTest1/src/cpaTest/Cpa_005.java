...
//	String username_wuzi = "13820781432";
	...
	String username_fg_zhineng= "18622708857";//生态建设部对应分管领导
	String passwd = "qw";
	String cpa_name = "自动化甲方合同-口头-生态建设部";
	String cpa_money = "1000";
	String cpa_dept = "生态建设部";
	String cpa_time = "1";
 	String cpa_xingzhi = "口头";
 	String cpa_type = "其他服务";
