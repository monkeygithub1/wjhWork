package wjh.pmis.testcase.fybx;
...
public class Fybx_9999 {
	...
	String money = "100";
	String bxType = "项目结项杂费";//特殊类型
	String pmo = "";
	String typeFlag = "cg";//空、cz、cg
	...
	//策划项目
//	String proj_ = "部门调整-P-一次性通过-1545283999580";
//	String proj_code = "SC-YWZX2018244";
//	String proj_id_ = "92e95130368d42a2875391c3c7157342";
	...
	public void fybxDemo() throws ClientProtocolException, IOException {
		...
		if (phone_sybdsz != ""){
			request.fybxSp(headermap, phone_sybdsz, fybxId, "1", "顺顺制杖");//事业部董事长
		}
