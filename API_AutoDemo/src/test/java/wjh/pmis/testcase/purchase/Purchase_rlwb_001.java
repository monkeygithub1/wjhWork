...
import wjh.pmis.restclient.RestClient;
	 ...
	 * 采购金额>10K，总经理审批
	 */
public class Purchase_rlwb_001 {
	...
	//一次性通过
	@Test
	public void purchase_rlwb_001() throws ClientProtocolException, IOException {
	...
	//每个节点拒绝一次
	@Test (priority=1)
	public void purchase_rlwb_001_Refuse() throws ClientProtocolException, IOException {
		Map<String, String> headermap = restClient.header();//获取信息头（带cookie）
		String purchaseId = "";
		String proc_id_ = "";
		request.login(headermap, phone_create);//登录
