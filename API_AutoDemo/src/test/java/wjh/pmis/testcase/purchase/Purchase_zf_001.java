...
public class Purchase_zf_001 {
	...
	String phone_zhglzz1 = dept_phone.phone_zhglzz1;
	
	String purchase_type = "7";
	String money_ = "10000";
	RestClient restClient = new RestClient();
	Request request = new Request();
	//一次性通过
	@Test
	public void purchase_zf_001_() throws ClientProtocolException, IOException{
		this.purchase_zf_001();
	}
	public String purchase_zf_001() throws ClientProtocolException, IOException {
		...
		request.purchaseSp(headermap, phone_zhglzz1, purchaseId, "1", "顺顺ZZ");
	...
	//每个节点拒绝一次
//	@Test (priority=1)
	public void purchase_zf_001_Refuse() throws ClientProtocolException, IOException {
		Map<String, String> headermap = restClient.header();//获取信息头（带cookie）
		String purchaseId = "";
		String proc_id_ = "";
		request.login(headermap, phone_create);//登录
		...
		request.purchaseSp(headermap, phone_dept, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_fg, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_zhglzz1, purchaseId, "2", "顺顺ZZ");
		//综合管理负责人
		this.purchaseEdit(headermap, purchaseId, proc_id_);
		request.purchaseSp(headermap, phone_pm, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_dept, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_fg, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_zhglzz1, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_zhglmgr, purchaseId, "2", "顺顺ZZ");
		//总经理
		this.purchaseEdit(headermap, purchaseId, proc_id_);
		request.purchaseSp(headermap, phone_pm, purchaseId, "1", "顺顺ZZ");
		request.purchaseSp(headermap, phone_dept, purchaseId, "1", "顺顺ZZ");
