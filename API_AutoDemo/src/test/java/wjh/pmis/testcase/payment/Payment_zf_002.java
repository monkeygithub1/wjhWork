...
public class Payment_zf_002 {
	...
	//一次性通过
	@Test
	public void payment_zf_002() throws ClientProtocolException, IOException {
	...
	//每个节点拒绝一次
	@Test(priority=1)
	public void payment_zf_002_Refuse() throws ClientProtocolException, IOException {
		Map<String, String> headermap = restClient.header();//获取信息头（带cookie）
		String paymentId = "";
		String proc_id_ = "";
		request.login(headermap, phone_create);//登录
