...
import wjh.pmis.testcase.purchase.Purchase_ywqt_001;
	/*
	 * 职能部门（安质部）
	 * 采购类型：3-业务外包/其他服务采购
	 * 是否电商：1-电商
	 */
public class Payment_ywqt_001 {
	...
	public void setUp() throws InterruptedException, ClientProtocolException, IOException {
		purchaseId = new Purchase_ywqt_001().purchase_ywqt_001();
	}
	//一次性通过
	@Test
	public void payment_ywqt_001() throws ClientProtocolException, IOException {
	...
	//每个节点拒绝一次
	@Test(priority=1)
	public void payment_ywqt_001_Refuse() throws ClientProtocolException, IOException {
		Map<String, String> headermap = restClient.header();//获取信息头（带cookie）
		String paymentId = "";
		String proc_id_ = "";
		request.login(headermap, phone_create);//登录
