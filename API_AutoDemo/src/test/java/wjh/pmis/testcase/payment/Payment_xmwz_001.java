...
import wjh.pmis.testcase.purchase.Purchase_xmwz_001;
	/*
	 * 职能部门（安质部）
	 * 采购类型：1-项目物资
	 * 是否电商：1-电商
	 */
public class Payment_xmwz_001 {
	...
	public void setUp() throws InterruptedException, ClientProtocolException, IOException {
		purchaseId = new Purchase_xmwz_001().purchase_xmwz_001();
	}
	//一次性通过
	@Test
	public void payment_xmwz_001() throws ClientProtocolException, IOException {
	...
	//每个节点拒绝一次
	@Test(priority=1)
	public void payment_xmwz_001_Refuse() throws ClientProtocolException, IOException {
		Map<String, String> headermap = restClient.header();//获取信息头（带cookie）
		String paymentId = "";
		String proc_id_ = "";
		request.login(headermap, phone_create);//登录
